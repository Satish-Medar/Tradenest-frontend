...
function Hero() {
  return (
    <div className="container">
      <div className="row">
        <div className="col-12 text-center p-5 border-bottom">
          <h1 className="pt-5 mt-5 mb-3 fs-2">Charges</h1>
          <p className="mb-5 text-muted fs-4">List of all charges and taxes</p>
        </div>
